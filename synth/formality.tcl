...
read_verilog -r { rtl/vending_pkg.sv \
                    rtl/comparator.sv \
                    rtl/subtractor.sv \
                    rtl/memory.sv \
                    rtl/control_unit.sv \
...
report_svf_operation -status accepted > synth/reports/formality_svf_accepted.rpt
report_svf_operation -status rejected > synth/reports/formality_svf_rejected.rpt

# Inspecione o resultado do casamento antes de seguir para verify
report_matched_points > synth/reports/formality_matched.rpt
report_unmatched_points > synth/reports/formality_unmatched.rpt
...
report_status -verbose > synth/reports/formality_status.rpt
report_passing_points > synth/reports/formality_passing.rpt
report_failing_points > synth/reports/formality_failing.rpt
report_unmatched_points > synth/reports/formality_unmatched.rpt
